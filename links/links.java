...
public class links
{
	public static class linksMapper extends Mapper<Object, Text, Text, IntWritable>
	{
	   boolean flag = false;		
   	   public void map (Object key, Text value, Context context) throws IOException,InterruptedException
		{
		 String line = value.toString();
		    if(flag)
			  ...
			  if(type.equals("link"))
			  { 
			     String date = s.nextToken();  // Retrieve data token
			     int add = 0;
	...
	public static void main(String args[]) throws Exception
	{
		...
		Job job=new Job(conf,"Links Count");
